  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.sections}>
        {renderSection("1. Account Settings", [
        ...
        {renderSection("2. Notification Settings", [
        ...
        {renderSection("3. Privacy Settings", [
